...
const Header = () => {
  return (
    <div className="header">
      <img
        className="logo"
        src="https://content.jdmagicbox.com/comp/banaskantha/p8/9999p2748.2748.210921232217.w9p8/catalogue/food-bite-cafe-deesa-restaurants-ggzj564xj8.jpg?clr="
      />
...
const resList = [
  ...
  },
  {
    data: {
      ...
      availability: {
        nextCloseTime: "2023-12-24 03:15:00",
        opened: true,
      },
      badges: {
        textExtendedBadges: [
  ...
  return (
    <div className="body"> 
      ...
      <div className="res-container">
        {/* map to loop through our api elements */}
        {
